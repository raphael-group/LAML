...
class EMTest(unittest.TestCase):
    ...
    def test_1(self): 
        ...
        mySolver = EM_solver([T],{'charMtrx':msa},{'Q':Q},{'phi':0,'nu':0,'ld':1.0,'ld':1.0})
    ...
    def test_9(self): 
        ...
        mySolver = EM_solver([T],{'charMtrx':msa},{'Q':Q},{'phi':0.1,'nu':0,'ld':1.0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
    ...
    def __test_outllh__(self,T,Q,msa,phi,nu,test_no,give_label=False):
        ...
        mySolver = EM_solver([T],{'charMtrx':msa},{'Q':Q},{'phi':phi,'nu':nu,'ld':1.0})
        if give_label:
            currIdx = 0
        ...
        for x in tree_reduced:    
            ...
            mySolver0 = EM_solver([tree_str],{'charMtrx':msa0},{'Q':Q},{'phi':phi,'nu':nu,'ld':1.0})
            ...
            mySolver1 = EM_solver([tree_str],{'charMtrx':msa1},{'Q':Q},{'phi':phi,'nu':nu,'ld':1.0})
    ...
    # test optimize_one
    def test_47(self):
        #treedata_path = pkg_resources.resource_filename('scmail', 'laml_unit_tests/test_data/test_EM/test4.tre')
