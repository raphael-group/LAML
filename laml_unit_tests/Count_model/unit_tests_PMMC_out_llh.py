...
class PMMCTest_out_llh(VirtualUnitTest):
    def check_outllh(self,T,Q,charMtrx,test_no=0,give_label=False,**params):
        super(PMMCTest_out_llh,self).check_outllh(T,Q,charMtrx,PMMC_model,"PMMCTest out llh",True,test_no=test_no,give_label=give_label,**params)
    ...
    def test_2(self):
        ...
        nu = 0.1
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=2)
    ...
    def test_4(self):
        ...
        nu = 0.15
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=4)
    ...
    def test_5(self):
        ...
        nu = 0.1
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=5)
    ...
    def test_6(self):
        ...
        nu = 0.19
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=6)
    ...
    def test_7(self):
        ...
        nu = 0.39
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=7)
    ...
    def test_8(self):
        ...
        nu = 0.39
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=8)
    ...
    def test_9(self):
        ...
        nu = 0.3
        phi = 0
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=9)
    ...
    def test_10(self):
        ...
        nu = 0.22
        phi = 0.3
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=10)
    ...
    def test_11(self):
        ...
        nu = 0.22
        phi = 0.01
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=11)
    ...
    def test_12(self):
        ...
        nu = 0.22
        phi = 0.2
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=12)
    ...
    def test_13(self):
        ...
        nu = 0.22
        phi = 0.5
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=13)
    ...
    def test_14(self):
        ...
        nu = 0.22
        phi = 0.01
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=14)
    ...
    def test_15(self):
        ...
        nu = 0.22
        phi = 0.9
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=15)
    ...
    def test_16(self):
        ...
        nu = 0.22
        phi = 0.03
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=16)
    ...
    def test_17(self):
        ...
        nu = 0.22
        phi = 0.5
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=17)
    ...
    def test_18(self):
        ...
        nu = 0.26
        phi = 0.7
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=18)
    ...
    def test_19(self):
        ...
        nu = 0.26
        phi = 0.1
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=19)
    ...
    def test_20(self):
        ...
        nu = 0.52
        phi = 0.8
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=20)
    ...
    def test_21(self):
        ...
        nu = 0.52
        phi = 0.001
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=21)
    ...
    def test_22(self):
        ...
        nu = 0.2
        phi = 0.82
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=22)
    ...
    def test_23(self):
        ...
        nu = 0.2
        phi = 0.1
        self.check_outllh(T,Q,charMtrx,mu=1,phi=phi,nu=nu,rho=1,test_no=23)
