...
from laml_libs.TopoSearch.Topology_search_parallel import Topology_search_parallel as Topology_search
from treeswift import *
from copy import deepcopy
from .virtual_unit_tests import VirtualUnitTest

class PMMNTest_TopoSearchParallel(VirtualUnitTest):
    ...
    def test_1(self):
        ...
        myTopoSearchParallel = Topology_search([T0],PMMN_model,data=data,prior=prior,params=params)
        my_strategy = deepcopy(DEFAULT_STRATEGY) 
        my_strategy['fixed_params'] = {'rho':1}
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,nreps=1,verbose=False,strategy=my_strategy)
        nllh_nni = -max_score
        
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_1 failed.")
    ...
    def test_2(self):
        ...
        my_strategy = deepcopy(DEFAULT_STRATEGY) 
        my_strategy['fixed_params'] = {'rho':1}
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,verbose=False,nreps=1,strategy=my_strategy)
        nllh_nni = -max_score
        
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_2 failed.")
    ...
    def test_3(self):
        ...
        my_strategy['fixed_params'] = {'rho':1}
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_3 failed.")
    ...
    def test_4(self):
        ...
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_4 failed.")
    ...
    def test_5(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_5 failed.") 
    ...
    def test_6(self):
        ...
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_6 failed.")
    ...
    def test_7(self):
        ...
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_7 failed.")
    ...
    def test_8(self):
        ...
        best_tree,max_score,best_params = myTopoSearchParallel.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_8 failed.")
    ...
    def test_9(self):
        ...
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMNTest_TopoSearchParallel: test_9 failed.")
