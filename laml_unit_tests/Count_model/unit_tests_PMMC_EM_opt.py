...
class PMMCTest_EM_opt(VirtualUnitTest):
    ...
    def test_1(self):
        ...
        alleleTable = AlleleTable(alleleTable,alphabet)
        ...
        for T,true_nllh in zip(tree_list,true_nllh_list):
            myModel = PMMC_model([T],{'DLT_data':alleleTable},{'Q':Q},{'mu':1,'nu':0,'phi':0,'rho':1})
            test_nllh,_ = myModel.optimize('EM',initials=1,verbose=-1,ultra_constr=False,fixed_params={'rho':1})
            self.assertAlmostEqual(true_nllh,test_nllh,places=4,msg="PMMCTest EM-opt: test_1 failed.")
    ...
    def test_2(self):
        ...
        for T,true_nllh in zip(tree_list,true_nllh_list):
            myModel = PMMC_model([T],{'DLT_data':alleleTable},{'Q':Q},{'mu':1,'nu':0,'phi':0,'rho':1})
            test_nllh,_ = myModel.optimize('EM',initials=1,verbose=-1,ultra_constr=False,fixed_params={'rho':1})
            self.assertAlmostEqual(true_nllh,test_nllh,places=4,msg="PMMCTest EM-opt: test_2 failed.")
    ...
    def test_3(self):
        ...
        myModel = PMMC_model([T],{'DLT_data':DLT_data},{'Q':Q})
        randseed = 1221
        ...
        self.assertAlmostEqual(0,abs(true_nllh-nllh)/true_nllh,places=4,msg="PMMCTest EM-opt: test_3 failed.")
        self.assertAlmostEqual(true_phi,phi,places=4,msg="PMMCTest EM-opt: test_3 failed.")
        self.assertAlmostEqual(true_nu,nu,places=4,msg="PMMCTest EM-opt: test_3 failed.")
    ...
    def test_4(self):
        ...
        phi = myModel.params.get_value('phi')
        nu = myModel.params.get_value('nu')
        self.assertAlmostEqual(0,abs(true_nllh-nllh)/true_nllh,places=4,msg="PMMCTest EM-opt: test_4 failed.")
        self.assertAlmostEqual(true_phi,phi,places=4,msg="PMMCTest EM-opt: test_4 failed.")
        self.assertAlmostEqual(true_nu,nu,places=4,msg="PMMCTest EM-opt: test_4 failed.")
