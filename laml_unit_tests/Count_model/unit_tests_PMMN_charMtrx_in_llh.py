import os 
import unittest
from laml_libs.Count_model.PMMN_charMtrx import *
from laml_libs.Count_model.Param import Param
...
class PMMNCharMtrxTest_in_llh(VirtualUnitTest):
    ...
    def test_1(self): 
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[(1,)],'c':[(1,)]},alphabet)
        true_nllh = 0.20665578828621584

        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0)
    ...
    def test_2(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(1,)],'b':[(1,)],'c':[(0,)]},alphabet)
    ...
    def test_3(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(1,)],'b':[(0,)],'c':[(1,)]},alphabet)
    ...
    def test_4(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[(1,)],'c':[(1,)]},alphabet)
        true_nllh = 3.917350291274164 
    ...
    def test_5(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(1,)],'b':[(0,)],'c':[(0,)]},alphabet)
    ...
    def test_6(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[(1,)],'c':[(0,)]},alphabet)
        true_nllh = 4.4586751457870815
    ...
    def test_7(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[(0,)],'c':[(1,)]},alphabet)
        true_nllh = 4.4586751457870815
    ...
    def test_8(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[(0,)],'c':[(0,)]},alphabet)
        true_nllh = 5.0
    ...
    def test_9(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[(0,)],'c':[('?',)]},alphabet)
        true_nllh = 6.513306124309698

        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_10(self): 
        ...
        J = 1
        alphabet = Alphabet(K,J,[[[0,1,-1]]])
        charMtrx = CharMtrx({'a':[(0,)],'b':[('?',)],'c':[(0,)]},alphabet)
        true_nllh = 6.513306124309698
    ...
    def test_11(self): 
        ...
        charMtrx = CharMtrx({'a':[('?',)],'b':[(0,)],'c':[(0,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_12(self): 
        ...
        charMtrx = CharMtrx({'a':[(0,)],'b':[(1,)],'c':[('?',)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_13(self): 
        ...
        charMtrx = CharMtrx({'a':[(0,)],'b':[('?',)],'c':[(1,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_14(self): 
        ...
        charMtrx = CharMtrx({'a':[('?',)],'b':[(0,)],'c':[(1,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_15(self): 
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[('?',)],'c':[(0,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_16(self): 
        ...
        charMtrx = CharMtrx({'a':[('?',)],'b':[(1,)],'c':[(0,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_17(self): 
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[(1,)],'c':[('?',)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_18(self): 
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[('?',)],'c':[(1,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_19(self): 
        ...
        charMtrx = CharMtrx({'a':[('?',)],'b':[(1,)],'c':[(1,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_22(self):
        ...
        charMtrx = CharMtrx({'a':[(1,0)],'b':[(1,0)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0,phi=0)
        my_nllh = myModel.negative_llh()
    ...
    def test_23(self): 
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[(1,)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0.05,phi=0)
        my_nllh = myModel.negative_llh()
    ...
    def test_24(self):
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[('?',)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0.05,phi=0)
        my_nllh = myModel.negative_llh()
    ...
    def test_26(self):
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[('?',)]},alphabet)
        myModel = PMMN_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0,phi=0.05)
        my_nllh = myModel.negative_llh()
    ...
    """
    def test_30(self):
        # Test that setting eta doesn't do anything in PMMN_charMtrx.
        Q = [[{1:1}]]
        true_nllh = 0.24959469115516922
        # lower is better, no missing rate is better model fit
        T = "((a:1,b:1)ab:1)r;"
        ...
        myModel = PMMN_charMtrx([T],{'alleleTable':allele_table},{'Q':Q},mu=11,nu=0,phi=0.5)
        my_nllh = myModel.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="PMMNTest in llh: test_28 failed.")
    """
