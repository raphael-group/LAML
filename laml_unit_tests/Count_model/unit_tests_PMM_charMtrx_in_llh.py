import os 
import unittest
from laml_libs.Count_model.PMM_charMtrx import *
...
class PMMCharMtrxTest_in_llh(VirtualUnitTest):
    ...
    def test_1(self): 
        ...
        myModel = PMM_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0)
    ...
    def test_9(self): 
        ...
        myModel = PMM_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=1,nu=0,phi=0.1)
        my_nllh = myModel.negative_llh()
    ...
    def test_22(self):
        ...
        myModel = PMM_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0,phi=0)
        my_nllh = myModel.negative_llh()
    ...
    def test_23(self): 
        ...
        myModel = PMM_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0.05,phi=0)
        my_nllh = myModel.negative_llh()
    ...
    def test_26(self):
        ...
        charMtrx = CharMtrx({'a':[(1,)],'b':[('?',)]},alphabet)
        myModel = PMM_charMtrx([T],{'charMtrx':charMtrx},{'Q':Q},mu=11,nu=0,phi=0.05)
        my_nllh = myModel.negative_llh()
    ...
    """
    def test_30(self):
        # Test that setting eta doesn't do anything in PMM_charMtrx.
        Q = [[{1:1}]]
        true_nllh = 0.24959469115516922
        # lower is better, no missing rate is better model fit
        T = "((a:1,b:1)ab:1)r;"
        ...
        myModel = PMM_charMtrx([T],{'alleleTable':allele_table},{'Q':Q},mu=11,nu=0,phi=0.5)
        my_nllh = myModel.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="PMMTest in llh: test_28 failed.")
    """
