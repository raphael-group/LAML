...
class PMMTest_TopoSearch(VirtualUnitTest):
    ...
    def test_1(self):
        ...
        myTopoSearch = Topology_search([T0],PMM_charMtrx,data=data,prior=prior,params=params)
        best_tree,max_score,best_params = myTopoSearch.search(maxiter=200,nreps=1,verbose=False)
        nllh_nni = -max_score
        
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMTest_TopoSearch: test_1 failed.")
    ...
    def test_2(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMTest_TopoSearch: test_2 failed.")
    ...
    def test_3(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMTest_TopoSearch: test_3 failed.")
    ...
    def test_4(self):
        ...
        best_tree,max_score,best_params = myTopoSearch.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMTest_TopoSearch: test_4 failed.")
