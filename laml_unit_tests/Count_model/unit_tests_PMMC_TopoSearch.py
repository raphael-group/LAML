...
class PMMCTest_TopoSearch(VirtualUnitTest):
    ...
    def test_1(self):
        ...
        data = {'DLT_data':AlleleTable(alleleTable,alphabet)}
        prior = {'Q':Q}
        params = {'phi':0,'nu':0,'mu':1,'rho':1}
        
        myTopoSearch = Topology_search([T0],PMMC_model,data=data,prior=prior,params=params)
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_1 failed.")
    ...
    def test_2(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_2 failed.")
    ...
    def test_3(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_3 failed.")
    ...
    def test_4(self):
        ...
        best_tree,max_score,best_params = myTopoSearch.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_4 failed.")
    ...
    def test_5(self):
        ...
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_5 failed.") 
    ...
    def test_6(self):
        ...
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_6 failed.")
    ...
    def test_7(self):
        ...
        best_tree,max_score,best_params = myTopoSearch.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_7 failed.")
    ...
    def test_8(self):
        ...
        best_tree,max_score,best_params = myTopoSearch.search(maxiter=200,verbose=False,strategy=my_strategy,nreps=1)
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_8 failed.")
    ...
    def test_9(self):
        ...
        nllh_nni = -max_score
        self.assertAlmostEqual(nllh_bf,nllh_nni,places=4,msg="PMMCTest_TopoSearch: test_9 failed.")
