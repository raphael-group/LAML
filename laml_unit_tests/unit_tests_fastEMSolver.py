...
class fastEMTest(unittest.TestCase):
    ...
    def test_1(self):
        ...
        mySolver = fastEM_solver([T],{'charMtrx':msa},{'Q':Q},{'phi':0,'nu':0})
        nllh,status = mySolver.score_tree(strategy={'ultra_constr':False,'fixed_phi':None,'fixed_nu':None,'fixed_brlen':None})
        nllh = - nllh
